...
export default {
  ...
  Creator: {
    ...
    EXIT_CONFIRM: 'You have unsaved data that will be lost if you leave the page. Are you sure want to leave the page?',
    sections: {
      QuestionSettings: {
    ...
    errors: {
      ...
      [ERR_TYPES.ERR_QUESTION_INVALID_CONFIG_TYPE]:
        'Question has invalid question config data type. Try to switch question type by choosing another and then return to the current one',
      [ERR_TYPES.ERR_QUESTION_ANSWER_OPTION_INVALID_ID]:
        'Some of answer option has invalid ID. Try to remove and add it again. Index of option: {DATA}',
      [ERR_TYPES.ERR_QUESTION_ANSWER_OPTION_EMPTY]: 'Answer option cannot be empty string. Option index: {DATA}',
      [ERR_TYPES.ERR_QUESTION_ANSWER_INVALID_TYPE]:
        'Question has invalid answer data type. Try to switch question type by choosing another and then return to the current one',
      ...
      [ERR_TYPES.ERR_QUESTION_ANSWER_CHILD_INVALID_ID]:
        'Answer option under index {DATA} has invalid id. Try to remove it and add again',
