...
export default {
  ...
  Creator: {
    ...
    errors: {
      ...
      [ERR_TYPES.ERR_QUESTION_UNKNOWN_TYPE]:
        'Питання має невідомий для нас тип. Спробуйте вибрати один з запропонованих',
      [ERR_TYPES.ERR_QUESTION_INVALID_CONFIG_TYPE]:
        'Питання має невірний формат конфігурації. Спробуйте змінити тип питання не інший, а потім на поточний',
      [ERR_TYPES.ERR_QUESTION_ANSWER_OPTION_INVALID_ID]:
        'Деякі відповіді мають недійсний ID. Спробуйте видалити їх та додати знов. Номер відповіді: {DATA}',
      [ERR_TYPES.ERR_QUESTION_ANSWER_OPTION_EMPTY]:
        'Варіант відповіді не може бути пустою строкою. Номер відповіді: {DATA}',
      [ERR_TYPES.ERR_QUESTION_ANSWER_INVALID_TYPE]:
        'Питання має недійсний тип данних. Спробуйте змінити тип питання не інший, а потім на поточний',
      ...
      [ERR_TYPES.ERR_QUESTION_ANSWER_CHILD_INVALID_ID]:
        'Варіант відповіді під номером {DATA} має недійсний ID. Спробуйте видалити його та додати знов',
